...
**Request Flow:** JSON-RPC Service → Middleware → HTTP Transport → Transport Middleware → Network

**Response Flow:** Network → Transport Middleware → HTTP Transport → Middleware → JSON-RPC Service
