...
- See [Transport Layer Architecture](2.0-transports.md) for the foundation
- See [HTTP Transport](2.1-http-transport.md) for HTTP details
- See [WebSocket Transport](2.2-ws-transport.md) for WebSocket details
- See [JSON-RPC Service](3.1-jsonrpc.md) for protocol layer
- See [Middleware](4.0-middleware.md) for middleware patterns
